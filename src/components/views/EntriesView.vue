  ...
  <div class="fixed inset-0 w-full flex flex-col bg-background-light dark:bg-background-dark overflow-x-hidden overflow-y-auto">
    ...
    <div class="fixed bottom-6 right-6">
      <button 
        ...
        class="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-14 w-14 bg-primary text-white shadow-lg hover:bg-primary/90 transition-colors"
      >
